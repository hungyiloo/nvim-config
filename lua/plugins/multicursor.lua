return {
  ...
  keys = {
    ...
    { mode = { "n" },      "<S-up>",        function () require("multicursor-nvim").lineAddCursor(-1) end    },
    { mode = { "n" },      "<C-S-up>",      function () require("multicursor-nvim").lineSkipCursor(-1) end   },
    { mode = { "n" },      "gmj",           function () require("multicursor-nvim").lineAddCursor(1) end     },
    { mode = { "n" },      "<S-down>",      function () require("multicursor-nvim").lineAddCursor(1) end     },
    { mode = { "n" },      "<C-S-down>",    function () require("multicursor-nvim").lineSkipCursor(1) end    },
