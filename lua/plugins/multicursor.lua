return {
  ...
  keys = {
    ...
    { mode = { "n" },      "gmk",           function () require("multicursor-nvim").lineAddCursor(-1) end    },
    { mode = { "n" },      "<up>",          function () require("multicursor-nvim").lineAddCursor(-1) end    },
    { mode = { "n" },      "<S-up>",        function () require("multicursor-nvim").lineSkipCursor(-1) end   },
    { mode = { "n" },      "gmj",           function () require("multicursor-nvim").lineAddCursor(1) end     },
    { mode = { "n" },      "<down>",        function () require("multicursor-nvim").lineAddCursor(1) end     },
    { mode = { "n" },      "<S-down>",      function () require("multicursor-nvim").lineSkipCursor(1) end    },
    { mode = { "n", "v" }, "gmm",           function () require("multicursor-nvim").matchAddCursor(1) end    },
    { mode = { "n", "v" }, "<right>",       function () require("multicursor-nvim").matchAddCursor(1) end    },
    { mode = { "n", "v" }, "gmn",           function () require("multicursor-nvim").matchSkipCursor(1) end   },
    { mode = { "n", "v" }, "<S-right>",     function () require("multicursor-nvim").matchSkipCursor(1) end   },
    { mode = { "n", "v" }, "gmM",           function () require("multicursor-nvim").matchAddCursor(-1) end   },
    { mode = { "n", "v" }, "<left>",        function () require("multicursor-nvim").matchAddCursor(-1) end   },
    { mode = { "n", "v" }, "gmN",           function () require("multicursor-nvim").matchSkipCursor(-1) end  },
    { mode = { "n", "v" }, "<S-left>",      function () require("multicursor-nvim").matchSkipCursor(-1) end  },
    ...
    { mode = { "n" },      "gmt",           function () require("multicursor-nvim").transposeCursors(1) end  },
    { mode = { "n" },      "gmT",           function () require("multicursor-nvim").transposeCursors(-1) end },
  },
  config = function()
    local mc = require("multicursor-nvim")
