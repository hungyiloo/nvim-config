...
-- NOTE: This hack might not be required anymore, since I found workarounds:
--       - neogit open with specific cwd instead of empty parameters (seems to set a matching root)
--       - project.nvim is now replaced with the simpler cd-project.nvim, since it had many bugs, including a lowercase drive letter issue
--
